...
p <- ggplot() + 
  ...
  transition_states(states=Lights.Colour, transition_length = 0, state_length = 0.5) +
  #transition_time(Lights.Colour, 0.5) +
  labs(x = "", y = "") +
  theme(legend.position = "none")

p

#(myAnimation <- animate(p, duration = 0.5, fps = 1, renderer = gifski_renderer(), res = 300, type = "cairo"))
