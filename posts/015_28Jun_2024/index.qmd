...
$$\frac{1+2+4+8+16+32+64+128+256+512+1024}{11} = 186.1$$
There are two ways to calculate the geometric mean by hand (but I will also show you how to do it in `R` as well):

The first way is to take the `nth` root of the product of all the terms:

$$\sqrt[11]{1*2*4*8*16*32*64*128*256*512*1024} = 32$$
and the second way is to take the exponent of the mean of the logged values:
